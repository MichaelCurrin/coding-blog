...
Update: besides the ability to create images that are persistd, you can also generate in realtime as you type, without any tokens needed. And there is a mode where you can draw for the AI to fill in.
