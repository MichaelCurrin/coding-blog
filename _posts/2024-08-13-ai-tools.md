...
This AI-focused IDE code creating and updating, tab auto-completion, and chats with persistent history with the AI.
...
Pricing:
- Free tier - a limited number of high-quality queries per month and then falls back to unlimited requests on the GPT-3.5. Go to your profile page on the Cursor website to see your usage so far.
...
See the [Pricing](https://www.cursor.com/pricing) page.
...
Uses:
- Local IDE (based on VS Code) with code-generation functionality.
- Browser-based IDE with the same functionality.

This is another AI-powered browser, by Google.
