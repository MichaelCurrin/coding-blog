...
Note that, on the free tier, Cursor provides you with a limited number of high-quality queries per month and then falls back to unlimited requests on the GPT-3.5. Go to your profile page on the Cursor website to see your usage so far.
